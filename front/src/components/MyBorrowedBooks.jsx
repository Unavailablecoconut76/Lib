          ...
          <table className="min-w-full border-collapse">
            <thead>
              <tr className="bg-gray-200">
                ...
                <th className="px-4py-2 text-left">Book Title</th>
                <th className="px-4py-2 text-left">Borrow Date</th>
                <th className="px-4py-2 text-left">Due Date</th>
                <th className="px-4py-2 text-left">Returned</th>
                <th className="px-4py-2 text-left">View</th>
              </tr>
            </thead>
            <tbody>
              {
