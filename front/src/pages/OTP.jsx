...
const OTP = () => {
  ...
  <div className="flex flex-col justify-center
   md:flex-row h-screen"></div>
  {/* left */}
  <div className="w-full md:w-1/2 flex 
  items-center justify-center bg-white 
  p-8 relative">

  <Link to={"/register"} className="border-2 border-black 
  ...
  <div className="max-w-sm w-full">
    <div className="flex justify-center mb-12">
      <div className="rounded-full flex items-center justify-center">
        <img src={logo_with_title_black} alt="logo" className="h-24 w-auto" />
      </div>
    </div>
    <h1 className="text-4xl font-medium text-center mb-12 overflow-hidden">Check your mailbox</h1>
    <p className="text-gray-800 text-center mb-12">please Enter OTP </p>
    <form onSubmit={handleOtpVerification}>
      ...
      <button type="submit" className="border-2 mt-5 border-black 
          ...
          hover:text-black transition">VERIFY
      </button>
    </form>
  </div>
  </div>
  ...
  justify-center p-8 rounded-tl-[80px] rounded-bl-[80px]">
    <div className="text-center h-[400px]">
      <div className="flex justify-center mb-12">
        <img src={logo_with_title_black} alt="logo" className="mb-12 h-44 w-auto"/>
      </div>

      <p className="text-gray-300 mb-12">sign up if new</p>
      <Link to={"/register"}className="border-2 mt-5 border-white 
      px-8 w-full font-semibold bg-black 
      text-white py-2 rounded-lg 
