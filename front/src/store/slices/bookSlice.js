...
export const fetchAllBooks =()=>async(dispatch)=>{
    ...
    await axios.get(`${appURL}/api/v1/book/all`,{withCredentials:true})
    .then(res=>{
...
export const addBook =(data)=>async(dispatch)=>{
    ...
    await axios.post(`${appURL}/api/v1/book/admin/add`,data,
...
export const deleteBook = (bookId) => async (dispatch) => {
    ...
    await axios.delete(`${appURL}/api/v1/book/delete/${bookId}`, {
      withCredentials: true
    })
    .then(res => {
