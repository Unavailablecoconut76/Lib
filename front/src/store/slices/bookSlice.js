...
export const fetchAllBooks = () => async(dispatch) => {
    ...
    await axios.get("https://lib-yq0u.onrender.com/api/v1/book/all", {
...
export const addBook =(data)=>async(dispatch)=>{
    ...
    await axios.post("https://lib-yq0u.onrender.com/api/v1/book/admin/add",data,
        {withCredentials:true,
            headers:{
...
export const deleteBook = (bookId) => async (dispatch) => {
    ...
    await axios.delete(`https://lib-yq0u.onrender.com/api/v1/book/delete/${bookId}`, {
      withCredentials: true
    })
    .then(res => {
