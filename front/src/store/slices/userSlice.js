...
export const fetchAllUsers=()=>async(dispatch)=>{
    ...
    await axios.get("https://lib-6n37.onrender.com/api/v1/user/all",{withCredentials:true})
    .then(res=>{
...
export const addNewAdmin=(data)=>async(dispatch)=>{
    ...
    await axios.post("https://lib-6n37.onrender.com/api/v1/user/add/new-admin",data,{
