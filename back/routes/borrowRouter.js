...
import { borrowedBook,getBorrowedBooksForAdmin,recordBorrowedBook,returnBorrowedBook } from "../controllers/borrowControllers.js";
...
router.get("/my-borrowed-books",isAuthenticated,borrowedBook);
